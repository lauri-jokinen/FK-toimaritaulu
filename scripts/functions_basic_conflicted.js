// In this file we have functions that might be useful outside of the context of table making.
...
function alphabetizeByLastName(array){
    lastNamesFirst = [];
